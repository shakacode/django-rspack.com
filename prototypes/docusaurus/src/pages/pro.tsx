...
const supportRows = [
  ...
  },
  {
    ...
    oss: 'Repository docs and issue triage',
    pro: 'Included',
  },
  {
  ...
  {
    feature: 'Integration planning for complex apps',
    oss: 'Self-service docs',
    pro: 'Hands-on consulting available',
  },
  {
    feature: 'Ongoing maintenance sponsorship',
...
export default function ProPage(): ReactNode {
  return (
    <Layout title="django-rspack Support" description="Support options for teams using django-rspack">
      <main className={styles.main}>
        <section className={styles.hero}>
          <div className="container">
            <h1>django-rspack Support</h1>
            <p>
              Start with the open-source docs and repository guidance. For teams that need
              implementation help or production hardening, ShakaCode provides direct support.
            </p>
        ...
        <section className="container">
          <div className={styles.policyCard}>
            <h2>Support Model</h2>
            <p>django-rspack is open source and fully usable without paid plans.</p>
            <p>
              If your team needs implementation help, deployment guidance, or higher-level
