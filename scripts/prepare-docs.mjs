...
async function writeDocsHome(docsRoot) {
  ...
  const markdown = `# django-rspack Documentation

Welcome to the official django-rspack documentation.

Canonical source lives in [shakacode/django-rspack](https://github.com/shakacode/django-rspack/tree/main/docs).
...
function detectCodeLanguage(content) {
  ...
  if (/^(yarn |npm |npx |bundle exec |rails |bin\/|pip |python |python3 )/.test(firstLine)) return "bash";
